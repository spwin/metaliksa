  ...
  <div class="item" id="content_1">
		...
		<div class="icon-container">
			<div class="icon-image-text">
				<img class="img-responsive-01" src="<?php echo Yii::app()->request->baseUrl; ?>/images/content_1/01-icon.png" alt="">
			...
			<div class="icon-image-text">
				<img class="img-responsive-02" src="<?php echo Yii::app()->request->baseUrl; ?>/images/content_1/02-icon.png" alt="">
			...
			<div class="icon-image-text">
				<img class="img-responsive-03" src="<?php echo Yii::app()->request->baseUrl; ?>/images/content_1/03-icon.png" alt="">
			...
			<div class="icon-image-text">
				<img class="img-responsive-04" src="<?php echo Yii::app()->request->baseUrl; ?>/images/content_1/04-icon.png" alt="">
		...
		<div class="bottom-right-text">
			...
			<div class="bottom-text">Cia gali buti trumpas aprasymas apie sia skilti. Lorem Ipsum awef pokvfovs pdofkeoc dspdk ; kdof o kpedo kwpdo aks; k;coskd;co k;eo ;sokc;slvk oekovskpvkvl kod</div>
		</div>
	</div>
